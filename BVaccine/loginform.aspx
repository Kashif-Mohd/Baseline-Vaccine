                        ...
                        <tr>
                            <td>
                                <table cellpadding="0" style="width:265px;">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtUserName" runat="server" Width="250px" placeholder="user name"></asp:TextBox>
                                            </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" Width="250px" placeholder="password"></asp:TextBox>
                                            </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
